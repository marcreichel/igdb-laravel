...
enum Category: int
{
    ...
    case GameEngineLogo = 841761378;
    case AlternativeName = 892514984;
    case ExternalGame = 948472134;
    case GameVersion = 952027844;
    case GameVersionFeatureValue = 1002943874;
    case Character = 1132440804;
    case GameEngine = 1151311720;
    case Platform = 1268564899;
    case Company = 1329346832;
    case PlatformVersionCompany = 1332753878;
    case Cover = 1379276330;
    case Artwork = 1395917662;
    case PlatformFamily = 1402993402;
    case PlatformLogo = 1415678713;
    case Theme = 1507925872;
    case Franchise = 1553623750;
    case MultiplayerMode = 1570917359;
    case Collection = 1687306101;
    case PlayerPerspective = 1779156388;
    case InvolvedCompany = 1833742404;
    case ReleaseDate = 1915704403;
    case Screenshot = 1934315057;
